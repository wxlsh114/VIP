...
class TestTeacher(unittest.TestCase):
    ...
    def switchLine(self):
        ...
        sleep(2)
        driver.find_element_by_android_uiautomator('new UiSelector().text("切换线路")').click()
        sleep(2)
...
if __name__ == '__main__':
    ...
    now=time.strftime('%Y-%m-%d %H_%M_%S')
    filename='./'+now+'_020b_result_R.html'
    fp=open(filename,'wb')
    runner=HTMLTestRunner(stream=fp,title='测试老师版android7.0真机(Honor8Lite)[切换线路]测试报告by Appium',
