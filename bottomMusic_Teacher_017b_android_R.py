...
if __name__ == '__main__':
    ...
    testunit.addTest(TestTeacher('bottomMusic'))
    now=time.strftime('%Y-%m-%d %H_%M_%S')
    filename='./'+now+'_017b_result_R.html'
    fp=open(filename,'wb')
    runner=HTMLTestRunner(stream=fp,title='测试老师版android7.0真机(Honor8Lite)[乐谱库]测试报告by Appium',
