...
class TestStudent(unittest.TestCase):
    ...
    def callService(self):
        ...
        sleep(2)
        driver.find_element_by_id('com.pnlyy.pnlclass.pnlclass_student.ceshi:id/ivCall').click()
        sleep(2)
...
if __name__ == '__main__':
    ...
    fp=open(filename,'wb')
    runner=HTMLTestRunner(stream=fp,title='测试学生版android7.0真机(Honor8Lite)[联系客服]测试报告by Appium',
